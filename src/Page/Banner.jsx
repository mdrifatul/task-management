  ...
  return (
    <div>
      ...
      <div className="h-80 md:h-[410px] flex flex-col justify-center  bg-black bg-opacity-50">
        ...
        <h2 className="text-2xl text-white md:text-4xl font-semibold mb-5 w-auto text-center">Analyze performance metrics to identify areas for improvement and optimize workflows</h2>
        </div>
        <Link to='/dashboard'>
